    ...
    public partial class Form1 : Form
    {
        ...
        private void btnAktar_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count - 1; i++)
            {
                ...
                cmd.CommandText = "insert into ProductPrice(ProductId,CompanyId,DbRow3,DbRow4,DbRow5,DbRow6) values(@ProductId,@CompanyId,@DbRow3,@DbRow4,@DbRow5,@DbRow6)";
                cmd.Parameters.Add("@CompanyId", CompanyId);
                cmd.Parameters.Add("@ProductId", productid);
                cmd.Parameters.Add("@DbRow2", CurrencyType);
                cmd.Parameters.Add("@DbRow3", decimal.Parse(dt.Rows[i][2].ToString()));
                cmd.Parameters.Add("@DbRow4", decimal.Parse(dt.Rows[i][3].ToString()));
                cmd.Parameters.Add("@DbRow5", decimal.Parse(dt.Rows[i][4].ToString()));
                ...
                cmd5.CommandText = "UPDATE Product set DbRow4=@DbRow4, DbRow3=@DbRow3,DbRow6=@DbRow6  where ProductId = '" + productid + "'";                   
                cmd5.Parameters.Add("@DbRow4", decimal.Parse(dt.Rows[i][7].ToString()));
                cmd5.Parameters.Add("@DbRow3", decimal.Parse(dt.Rows[i][8].ToString()));
                cmd5.Parameters.Add("@DbRow6", decimal.Parse(dt.Rows[i][9].ToString()));
